...
var ViewStyler = (function () {
    ...
    ViewStyler.setPaddingProperty = function (view, newValue) {
        ...
        var left = Math.round((style.paddingLeft + view.borderWidth) * density);
        var top = Math.round((style.paddingTop + view.borderWidth) * density);
        var right = Math.round((style.paddingRight + view.borderWidth) * density);
        var bottom = Math.round((style.paddingBottom + view.borderWidth) * density);
